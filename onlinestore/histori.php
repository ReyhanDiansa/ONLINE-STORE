...
<table class="table table-hover table-striped">
    ...
    <tbody>
        <?php 
        include "koneksi.php";
        $sql = mysqli_query($conn, "SELECT A.nama_produk,B.tgl_transaksi,A.harga,C.qty,C.subtotal FROM produk A JOIN transaksi B ON A.id_produk=B.id_produk JOIN detail_transaksi C ON B.id_transaksi=C.id_transaksi WHERE B.id_pelanggan='$id'" );
