        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title" style="color:black;"> Tambah Produk</h3>
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <form class="forms-sample" action="proses_tambah_produk.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" name ="desk" rows="4" required></textarea>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputCity1">Harga<span style="color:red;">*</span></label>
                        <input type="number" class="form-control" id="exampleInputCity1" name="harga" placeholder="ex. 200000" required>
                      </div>
                      <div class="form-group">
